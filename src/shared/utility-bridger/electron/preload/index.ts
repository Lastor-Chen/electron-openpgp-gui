import type { ErrorLike, WindowRpcChild } from '@utility-bridger/types'
import { ipcRenderer, contextBridge } from 'electron'
import type { IpcRendererEvent } from 'electron'

export function bridgeRpcChild() {
  /** 紀錄已經 crash 的子程序 */
  ...
  contextBridge.exposeInMainWorld('rpcChild', {
